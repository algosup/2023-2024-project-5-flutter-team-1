...
import 'pages/candidate/chatpage.dart';
...
final routes = GoRouter(routes: [
  GoRoute(
    ...
    builder: (BuildContext context, GoRouterState state) =>
        LanguageHomePage(storage: GetUserData()),
  ),
  GoRoute(
    path: "/languagehomepagecompany",
    name: "LanguageHomePageCompany",
    builder: (BuildContext context, GoRouterState state) =>
        LanguageHomePageCompany(storage: GetUserDataCompany()),
  ),
  GoRoute(
    path: "/",
    name: "RedirectionPage",
    builder: (BuildContext context, GoRouterState state) =>
        RedirectionPage(storage: DocumentStorage()),
  ),
  GoRoute(
    path: "/loginpage",
    name: "LoginPage",
    builder: (BuildContext context, GoRouterState state) =>
        LoginPage(storage: DataClass()),
  ),
  GoRoute(

      ...
      body: SafeArea(
        child: Column(
              ...
              Column(
                ...
                child:
                  Row(
                    ...
                    children: [
                    Checkbox(value: checkOne, activeColor: Colors.green, tristate:false, onChanged: (newbool) {
                      setState(() {
                        checkOne = newbool;
                      });
                    }),
                    Text("${rText[lang]}", style: GoogleFonts.poppins(
                      textStyle: TextStyle(
                        fontSize: 18,
          ...
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text("${yText[lang]}", style: GoogleFonts.poppins(
                textStyle: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w400,
                  color: Colors.black,
              ...
              Text("${iText[lang]}", style: GoogleFonts.poppins(
                textStyle: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w400,
                  color: Colors.black,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                Checkbox(value: checkTwo, activeColor: Colors.green, tristate: false, onChanged: (newbool) {
                  setState(() {
                    checkTwo = newbool;
                  });
                },),
                Text("${iaText[lang]}", style: GoogleFonts.poppins(
                  textStyle: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.w300,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: (checkOne! && checkTwo!) ? Colors.green : Colors.grey,
            ),
            child: Center(
              child: Text("${nextText[lang]}", style: GoogleFonts.poppins(
              textStyle: const TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w300,
                color: Colors.white,
